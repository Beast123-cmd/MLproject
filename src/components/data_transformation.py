...
class datatransformation:
    ...
    def get_datatransformar_obj(self):

        '''
        This function is resopsible for data transormation
        '''
        ...
        try:
            ...
            preprocessor=ColumnTransformer(
                [
                    ("num_pipelines",num_pipeline,numerical_cols),
    ...
    def initiate_data_trasnformation(self,train_path,test_path):
        try:
            ...
            preprocesser_obj=self.get_datatransformar_obj()
            ...
            input_feature_test_df=train_df.drop(columns=target_col,axis=1)
            target_feature_test_df=train_df[target_col]

            logging.info("Applying the preprocessing obj on training dataframe and testing dataframe")
